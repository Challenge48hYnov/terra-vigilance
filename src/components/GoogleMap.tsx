...
const GoogleMap: React.FC<GoogleMapProps> = ({ selectedZones, selectedLayers, activeAlerts }) => {
        ...
        return [
            ...
            },
            {
                ...
                coordinates: [
                    ...
                    { lat: 45.7510, lng: 4.8290 },
                    { lat: 45.7490, lng: 4.8260 },
                    { lat: 45.7470, lng: 4.8250 }, // Point plus au sud
                    { lat: 45.7450, lng: 4.8240 }, // Point plus au sud
                    { lat: 45.7440, lng: 4.8230 }, // Pointe sud du confluent
                    { lat: 45.7460, lng: 4.8220 }, // Remonte le long de la Saône
                    { lat: 45.7480, lng: 4.8230 },
                    { lat: 45.7510, lng: 4.8240 },
                    { lat: 45.7530, lng: 4.8250 },
            ...
            },
            {
                ...
                coordinates: [
                    { lat: 45.7590, lng: 4.8350 },
                    { lat: 45.7640, lng: 4.8400 },
                    { lat: 45.7620, lng: 4.8420 },
                    { lat: 45.7590, lng: 4.8450 },
                    { lat: 45.7570, lng: 4.8500 },
                    { lat: 45.7550, lng: 4.8580 },
                    { lat: 45.7520, lng: 4.8540 },
                    { lat: 45.7500, lng: 4.8500 },
                    { lat: 45.7480, lng: 4.8450 },
                    { lat: 45.7460, lng: 4.8430 }, // Nouveau point pour étendre vers le sud
                    { lat: 45.7450, lng: 4.8400 }, // Nouveau point pour étendre vers le sud
    ...
    const drawDistrictBoundaries = (map: any) => {
        ...
        const districts = [
            // Presqu'île (1) - Coordonnées révisées
            {
                name: 'Presqu\'île',
                id: 1,
                color: '#4ADE80', // Green
                textColor: '#166534',
                coordinates: [
                    { lat: 45.7700, lng: 4.8300 }, // Point nord
                    { lat: 45.7680, lng: 4.8360 }, // Côté est (Rhône)
                    { lat: 45.7650, lng: 4.8380 },
                    { lat: 45.7630, lng: 4.8370 },
                    { lat: 45.7610, lng: 4.8350 },
                    { lat: 45.7590, lng: 4.8350 }, // Jonction avec Guillotière
                    { lat: 45.7570, lng: 4.8320 },
                    { lat: 45.7550, lng: 4.8290 }, // Point sud
                    { lat: 45.7560, lng: 4.8270 }, // Côté ouest (Saône)
                    { lat: 45.7580, lng: 4.8260 },
                    { lat: 45.7610, lng: 4.8280 },
                    { lat: 45.7630, lng: 4.8280 },
                    { lat: 45.7670, lng: 4.8280 } // Remontée nord-ouest
                ]
            },

            // Confluence (2) - Coordonnées révisées
            {
                name: 'Confluence',
                id: 2,
                ...
                textColor: '#166534',
                coordinates: [
                    { lat: 45.7550, lng: 4.8290 }, // Connexion avec Presqu'île
                    { lat: 45.7570, lng: 4.8320 },
                    { lat: 45.7550, lng: 4.8340 }, // Est
                    { lat: 45.7530, lng: 4.8320 }, // Connexion avec Guillotière
                    { lat: 45.7500, lng: 4.8300 },
                    { lat: 45.7470, lng: 4.8270 },
                    { lat: 45.7450, lng: 4.8250 },
                    { lat: 45.7430, lng: 4.8230 }, // Pointe sud du confluent
                    { lat: 45.7440, lng: 4.8210 }, // Remontée Saône
                    { lat: 45.7460, lng: 4.8200 },
                    { lat: 45.7490, lng: 4.8220 },
                    { lat: 45.7520, lng: 4.8250 },
                    { lat: 45.7540, lng: 4.8270 }
                ]
            },

            // Part-Dieu (3) - Coordonnées révisées
            {
                name: 'Part-Dieu',
                id: 3,
                color: '#38BDF8', // Blue
                textColor: '#0369A1',
                coordinates: [
                    { lat: 45.7640, lng: 4.8380 }, // Connexion ouest
                    { lat: 45.7680, lng: 4.8430 }, // Nord-ouest
                    { lat: 45.7700, lng: 4.8500 }, // Nord
                    { lat: 45.7680, lng: 4.8580 }, // Nord-est
                    { lat: 45.7650, lng: 4.8650 },
                    { lat: 45.7600, lng: 4.8720 }, // Est
                    { lat: 45.7550, lng: 4.8650 }, // Sud-est
                    { lat: 45.7580, lng: 4.8550 }, // Sud
                    { lat: 45.7600, lng: 4.8470 },
                    { lat: 45.7620, lng: 4.8420 } // Sud-ouest
                ]
            },
            ...
            // District 7 (Blue - Guillotière) - Coordonnées révisées selon la carte
            {
                name: 'Guillotière',
                id: 7,
                ...
                textColor: '#0369A1',
                coordinates: [
                    { lat: 45.7560, lng: 4.8340 }, // Point de départ plus bas
                    { lat: 45.7590, lng: 4.8350 },
                    { lat: 45.7620, lng: 4.8380 }, // Point est proche du Rhône
                    { lat: 45.7630, lng: 4.8450 }, // Point nord-est
                    { lat: 45.7580, lng: 4.8520 }, // Point est
                    { lat: 45.7550, lng: 4.8580 }, // Connexion avec Monplaisir
                    { lat: 45.7520, lng: 4.8540 }, // Point sud-est
                    { lat: 45.7480, lng: 4.8500 },
                    { lat: 45.7450, lng: 4.8450 }, // Point sud
                    { lat: 45.7430, lng: 4.8400 }, // Point sud-ouest plus bas
                    { lat: 45.7460, lng: 4.8360 }, // Sud-ouest
                    { lat: 45.7510, lng: 4.8330 }, // Remontée
                    { lat: 45.7530, lng: 4.8320 } // Connexion avec point de départ
                ]
            },
            // Monplaisir (8) - Coordonnées révisées
            {
                name: 'Monplaisir',
                id: 8,
                ...
                textColor: '#0369A1',
                coordinates: [
                    { lat: 45.7550, lng: 4.8580 }, // Connexion nord avec Guillotière
                    { lat: 45.7550, lng: 4.8650 }, // Connexion nord avec Part-Dieu
                    { lat: 45.7580, lng: 4.8750 }, // Nord-est
                    { lat: 45.7550, lng: 4.8850 }, // Est
                    { lat: 45.7480, lng: 4.8800 }, // Sud-est
                    { lat: 45.7430, lng: 4.8700 }, // Sud
                    { lat: 45.7440, lng: 4.8600 }, // Sud-ouest
                    { lat: 45.7470, lng: 4.8550 }, // Ouest
                    { lat: 45.7500, lng: 4.8520 }  // Nord-ouest
                ]
            },
